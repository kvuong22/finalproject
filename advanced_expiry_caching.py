...
class Cache:
    def __init__(self, filename): #need filename for constructor
        """Load cache from disk, if present""" #doc string to say what it does
    ...
    def _save_to_disk(self): #can be used in other methods but other programmers should not use it
        """Save cache to disk"""
    ...
    def get(self, identifier): #one cache to the file
